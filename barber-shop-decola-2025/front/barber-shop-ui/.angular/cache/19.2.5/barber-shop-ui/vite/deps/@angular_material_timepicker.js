...
} from "./chunk-FYUR6QCB.js";
import {
  MAT_FORM_FIELD
} from "./chunk-CWNNRABA.js";
import {
  Overlay,
  TemplatePortal
} from "./chunk-T6BMKEIR.js";
import {
  animate,
  group,
  state,
  ...
  transition,
  trigger
} from "./chunk-3RTCGL7Z.js";
import {
  CdkScrollableModule
} from "./chunk-A4NTKCZ2.js";
import "./chunk-2W2JJEUP.js";
import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR,
  Validators
} from "./chunk-JPBHAI4F.js";
import {
  MatIconButton
} from "./chunk-TNJ6YLIZ.js";
import {
  ...
  _IdGenerator,
  hasModifierKey
} from "./chunk-VDRQPNH5.js";
import {
  Directionality
} from "./chunk-NQJTGM3T.js";
import "./chunk-RCMP25MK.js";
import {
  _getEventTarget
} from "./chunk-EGS44DXL.js";
import {
  DOCUMENT
} from "./chunk-VANRHKWZ.js";
import {
...
function MatTimepicker_ng_template_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("onSelectionChange", function MatTimepicker_ng_template_0_For_2_Template_mat_option_onSelectionChange_0_listener() {
      const option_r2 = ɵɵrestoreView(_r1).$implicit;
      const ctx_r2 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r2._selectValue(option_r2.value));
    });
    ɵɵtext(1);
    ɵɵelementEnd();
  }
...
function MatTimepicker_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("id", ctx_r2.panelId)("@panel", void 0);
    ɵɵattribute("aria-label", ctx_r2.ariaLabel() || null)("aria-labelledby", ctx_r2._getAriaLabelledby());
    ɵɵadvance();
    ɵɵrepeater(ctx_r2._timeOptions);
  }
}
...
var MatTimepicker = class _MatTimepicker {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 0,
    consts: [["panelTemplate", ""], ["role", "listbox", 1, "mat-timepicker-panel", 3, "id"], [3, "value"], [3, "onSelectionChange", "value"]],
    template: function MatTimepicker_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, MatTimepicker_ng_template_0_Template, 3, 4, "ng-template", null, 0, ɵɵtemplateRefExtractor);
      }
    },
    ...
    encapsulation: 2,
    data: {
      animation: [trigger("panel", [state("void", style({
        opacity: 0,
        transform: "scaleY(0.8)"
      })), transition(":enter", [group([animate("0.03s linear", style({
        opacity: 1
      })), animate("0.12s cubic-bezier(0, 0, 0.2, 1)", style({
        transform: "scaleY(1)"
      }))])]), transition(":leave", [animate("0.075s linear", style({
        opacity: 0
      }))])])]
    },
    changeDetection: 0
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatTimepicker, [{
    ...
    args: [{
      ...
      animations: [trigger("panel", [state("void", style({
        opacity: 0,
        transform: "scaleY(0.8)"
      })), transition(":enter", [group([animate("0.03s linear", style({
        opacity: 1
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTimepickerToggle_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵattribute("aria-label", ctx.ariaLabel())("aria-expanded", ctx.timepicker().isOpen())("tabindex", ctx._isDisabled() ? -1 : ctx.tabIndex());
      }
    },
